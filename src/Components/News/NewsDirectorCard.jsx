        ...
        <div>
            <div className='flex flex-wrap justify-center gap-10'>
                {data.map((item, index) => (
                    ...
                    <div className='relative bg-purple-950/40 rounded-lg'>
                        <div key={index} className='h-60 w-90 lg:w-100 flex justify-between gap-2 border border-gray-700 rounded-lg overflow-hidden relative'>
                            <img src={item.cover_picture} className='h-full rounded-lg' alt="" style={{ width: "80%",maskImage: "linear-gradient(to left, transparent, black)", WebkitMaskImage: "linear-gradient(to left, transparent, black)"}}/>
                            ...
                            <div className='absolute bottom-2 left-2 right-2 flex justify-between'>
                                <p className='text-sm py-1 px-2 bg-purple-600/60 rounded-md  font-semibold'>Remind Me</p>
                                <p className='text-sm py-1 px-2 border border-purple-600/70 bg-black/70 rounded-md font-semibold'>learn more...</p>
                            </div>
